...
pub struct AppIntegration {
    ...
    /// This is the AI application's token, which DeepJelly uses to call the AI application.
    #[serde(rename = "authToken", skip_serializing_if = "Option::is_none")]
    pub auth_token: Option<String>,

    /// DeepJelly's API token (optional, max 500 characters)
    /// This token is generated by DeepJelly and used by the AI application to call DeepJelly's HTTP API.
    #[serde(rename = "deepjellyToken", skip_serializing_if = "Option::is_none")]
